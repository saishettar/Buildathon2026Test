...
REAL_SCENARIO_META: list[dict] = [
    ...
    },
    {
        ...
        "description": "Real Claude-powered fact-checking agent that verifies claims using parallel multi-source research and delivers a confidence-rated verdict",
        "real": True,
        "icon": "search",
    },
    {
        ...
        "label": "API Integration Planner",
        "description": "Real Claude-powered agent that designs a Stripe-to-Postgres integration with webhook handler and database layer code generation",
        "real": True,
        "icon": "plug",
    },
    {
        ...
        "description": "Real Claude-powered SRE agent that triages alerts, runs parallel diagnostics, identifies root cause, and drafts communications",
        "real": True,
        "icon": "alert",
    },
    {
        ...
        "label": "Query Optimizer Agent",
        "description": "Real Claude-powered database agent that analyzes slow SQL queries, rewrites them, generates indexes, and estimates performance gains",
        "real": True,
        "icon": "database",
    },
    {
        "id": "microservice_decomposition",
        "name": "Microservice Decomposition Agent",
        "label": "Microservice Decomposition Agent",
        "description": "Real Claude-powered architect agent that decomposes a monolith into microservices with API design, communication mapping, and migration planning",
        "real": True,
        "icon": "layers",
    },
    {
        ...
        "label": "Contract Analyzer Agent",
        "description": "Real Claude-powered legal analyst that reviews SaaS contracts, risk-rates clauses, and drafts redline negotiation suggestions",
        "real": True,
        "icon": "file-text",
    },
]
